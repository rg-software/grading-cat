...
def jplag_preprocessor(config, assignment_name):
	interop.jplag_preprocessor.preprocess_dirs(config["moodle_submissions_dir"], config["archive_dirs"], config['assignment_regex'], assignment_name)
...
if __name__ == "__main__":
	if len(sys.argv) < 3:
		...
		print("moodle_downloader.py <project-dir>")
		sys.exit(1)
