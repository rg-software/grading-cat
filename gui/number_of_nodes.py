...
from PySide6.QtWidgets import QDialog, QGridLayout, QLabel, QSizePolicy
from PySide6.QtWidgets import QSpacerItem, QSpinBox, QDialogButtonBox
    ...
    def __init__(self, parent):
        ...
        labelPlease.setText(
            QCoreApplication.translate(
                "Dialog", "Please enter the expected\nnumber of nodes", None
            )
        )
